...
export class MatrixElementBase implements IMatrixElementBase {
	...
	public get id(): IMatrixElementBase['_placeId'] {
...
export class MatrixEmitService {
	private readonly matrixData$: BehaviorSubject<MatrixElementBase[][]> = new BehaviorSubject<
		MatrixElementBase[][]
	>([]);

	public getMatrixData(): Observable<MatrixElementBase[][]> {
		return this.matrixData$.asObservable();
	}

	public setMatrixData(value: MatrixElementBase[][]): void {
